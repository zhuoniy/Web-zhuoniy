		...
		//		}
	        ...
	        if(given === answer) {
	            console.log("you win");
	            let congrats = `<p id="winner" class="">Congratulations! You win! </p><a class="modal-close btn-primary btn" onclick="getItem(3)">Exit</a>`
	        ...
	        if(given === answer) {
	            console.log("you win");
	            let congrats = `<p id="winner" class="">Congratulations! You win! </p><a class="modal-close btn-primary btn" onclick="getItem(1)">Exit</a>`
